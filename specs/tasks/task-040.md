...
3. During the animation, the tree layout should update to show the new node (the add-node animation from task-031 plays concurrently with the zoom-out phase).
